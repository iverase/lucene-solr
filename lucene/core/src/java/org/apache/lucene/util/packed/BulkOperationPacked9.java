...
final class BulkOperationPacked9 extends BulkOperationPacked {
  ...
  public void decode(byte[] blocks, int blocksOffset, long[] values, int valuesOffset, int iterations) {
    for (int i = 0; i < iterations; ++i) {
      ...
      values[valuesOffset++] = ((byte2 & 3L) << 7) | (byte1 >>> 1);
      final long byte3 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte3 & 7L) << 6) | (byte2 >>> 2);
      final long byte4 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte4 & 15L) << 5) | (byte3 >>> 3);
      final long byte5 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte5 & 31L) << 4) | (byte4 >>> 4);
      final long byte6 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte6 & 63L) << 3) | (byte5 >>> 5);
      final long byte7 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte7 & 127L) << 2) | (byte6 >>> 6);
