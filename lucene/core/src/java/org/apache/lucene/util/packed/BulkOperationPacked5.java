...
final class BulkOperationPacked5 extends BulkOperationPacked {
  ...
  public void decode(byte[] blocks, int blocksOffset, long[] values, int valuesOffset, int iterations) {
    for (int i = 0; i < iterations; ++i) {
      ...
      values[valuesOffset++] = byte0 & 31L;
      final long byte1 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte1 & 3) << 3) | (byte0 >>> 5);
      values[valuesOffset++] = (byte1 >>> 2) & 31L;
      final long byte2 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte2 & 15L) << 1) | (byte1 >>> 7);
      final long byte3 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte3 & 1) << 4) | (byte2 >>> 4);
      values[valuesOffset++] = (byte3 >>> 1) & 31L;
      final long byte4 = blocks[blocksOffset++] & 0xFF;
      values[valuesOffset++] = ((byte4 & 7L) << 2) | (byte3 >>> 6);
      values[valuesOffset++] = (byte4 >>> 3) & 31L;
    }
  }
