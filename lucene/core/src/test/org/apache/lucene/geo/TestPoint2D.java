...
public class TestPoint2D extends LuceneTestCase {
  ...
  public void testTriangleDisjoint() {
    ...
    double cx = 5;
    double cy = 4;
    assertFalse(point2D.intersectsTriangle(ax, ay, true, bx, by, true, cx, cy, true));
    assertFalse(point2D.intersectsLine(ax, ay, true, bx, by));
    assertFalse(point2D.containsTriangle(ax, ay, true, bx, by, true, cx, cy, true));
    assertFalse(point2D.containsLine(ax, ay, true, bx, by));
  ...
  public void testTriangleIntersects() {
    ...
    double cx = 0;
    double cy = 1;
    assertTrue(point2D.intersectsTriangle(ax, ay, true, bx, by, true, cx, cy, true));
    assertTrue(point2D.intersectsLine(ax, ay, true, bx, by));
    assertFalse(point2D.containsTriangle(ax, ay, true, bx, by, true, cx, cy, true));
    assertFalse(point2D.containsLine(ax, ay, true, bx, by));
