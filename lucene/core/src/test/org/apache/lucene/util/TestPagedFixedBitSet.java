...
public class TestPagedFixedBitSet extends BaseBitSetTestCase<PagedFixedBitSet> {

  @Override
  public PagedFixedBitSet copyOf(BitSet bs, int length) throws IOException {
    final PagedFixedBitSet set = new PagedFixedBitSet(length);
  ...
  void doNextSetBit(java.util.BitSet a, SparseFixedBitSet b) {
    assertEquals(a.cardinality(), b.cardinality());
    int aa=-1;
    int bb=-1;
    do {
...
//      SparseFixedBitSet b = new SparseFixedBitSet(sz);
//
...
//  }
  ...
  */
  ...
  public void testEquals() {
    ...
    PagedFixedBitSet b1 = new PagedFixedBitSet(numBits);
    PagedFixedBitSet b2 = new PagedFixedBitSet(numBits);
...
//    SparseFixedBitSet obs = new SparseFixedBitSet(a, numBits);
//    java.util.BitSet bs = makeBitSet(a);
//    doNextSetBit(bs, obs);
//  }
