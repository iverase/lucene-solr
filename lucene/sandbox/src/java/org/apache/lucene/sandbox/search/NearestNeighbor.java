      ...
      if (cell.index.moveToChild() == false) {
        ...
        cellQueue.offer(
            new Cell(
                ...
                approxBestDistance(newIndex.getMinPackedValue(), newIndex.getMaxPackedValue(), pointLat, pointLon)));
        ...
        if (cell.index.moveToSibling()) {
          cellQueue.offer(
                  new Cell(
                          ...
                          approxBestDistance(cell.index.getMinPackedValue(), cell.index.getMaxPackedValue(), pointLat, pointLon)));
        }
      }
    }
